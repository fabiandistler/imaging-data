...
rio::export(df_behavior, "data/df_behavior.rds")
```
...
df_traces <- t(df[["caim"]][[15]]) |>
  ...
  tidytable::mutate(time_ms = df_behavior$time_ms) |>
  tidytable::pivot_longer(
    cols = tidytable::everything(),
    names_to = "component",
    values_to = "normalized_signal"
  )
rio::export(df_traces, "data/df_traces.rds")
```
